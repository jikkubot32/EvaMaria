...
async def next_page(bot, query):
    ...
    if not search:
        await query.answer("⚠️ Hey, You are using one of my old messages, send the request again ⚠️",show_alert=True)
        return
...
async def advantage_spoll_choker(bot, query):
    ...
    if not movies:
        return await query.answer("⚠️ Hey, You are clicking on an old button which is expired ⚠️", show_alert=True)
    ...
    if k==False:
        ...
        if files:
            ...
            k = await query.message.edit('⚠️ Hey, This Movie Not Found In My DataBase ⚠️')
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('🎸 Join Our Official Channel 🎸', url='https://t.me/FilmClubChannel')
            ]
            ]
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🤖 Updates', url='https://t.me/FilmClubChannel')
            ],[
        ...
        buttons= [[
            InlineKeyboardButton('📥 Channel', url='https://t.me/FilmClubChannel'),
